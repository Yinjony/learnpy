...
from videox_fun.models.wan_transformer3d_ours import WanTransformer3DModel

from videox_fun.models.cache_utils import get_teacache_coefficients

from videox_fun.pipeline.pipeline_wan_ours import WanPipeline
...
# model path
model_name          = "/root/data1/yizeli/VideoX-Fun/models/Wan2.1-T2V-1.3B"

prompt_file         = "/root/data1/yizeli/VideoX-Fun/examples/wan2.1/all_dimension.txt"

save_path           = "/root/data1/yizeli/VideoX-Fun/examples/wan2.1/vbench_videos/cpo_stage1_model"
...
lora_path    = "/root/data1/yizeli/VideoX-Fun/scripts/wan2.1/output_dir_cpo_stage1_1.3b/checkpoint-54500.safetensors"
score_path   = "/root/data1/yizeli/VideoX-Fun/scripts/wan2.1/output_dir_cpo_stage1_1.3b/score_modules-54500.safetensors"
...
prompt_list = list(dict.fromkeys(prompt_list))  # 去重保序
...
with torch.no_grad():
    ...
    for i, prompt in enumerate(prompt_list):
        ...
        if video_filename in existing:
            print(f"[{i + 1}/{len(prompt_list)}] Skip (exists): {video_filename[:80]}...")
            continue

        print(f"[{i + 1}/{len(prompt_list)}] Generating: {prompt[:80]}...")
...
print(f"Done! Videos saved to {save_path}")